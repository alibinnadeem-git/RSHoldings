...
/*
  Native semantic scene imagery is authoritative.
  Old generated fallback runs only if static scene injection
  is absent for any reason.
*/
if (!document.querySelector(".native-scene")) {
  renderSceneFallbacks();
}
